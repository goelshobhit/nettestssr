...
const Page = () => {
  ...
  return (
    <div>
      <Head>
        <title>{pageData.name} | Vamp By Night Studios </title>
        <meta
          name="description"
          content={get(
            pageData,
            'background_html',
            'My childe, alway remember this most important lesson: sanguis pretium amissis ludum. Blood is the price of losing the game.'
          )}
        />
